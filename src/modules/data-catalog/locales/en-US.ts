...
export const dataCatalogEnUS = {
  dataCatalog: {
    ...
    resourceWorkspace: {
      ...
      refreshMetadataConfirmTitle: "Refresh resource metadata?",
      refreshMetadataConfirmDescription: "This creates a metadata refresh task. Field definitions, resource status, and index availability may change when it completes.",
      refreshMetadataConfirm: "Create refresh task",
      enableConfirmTitle: "Enable resource?",
      enableConfirmDescription: "Enabling restores preview, query, and index-build access for this resource.",
      disableConfirmTitle: "Disable resource?",
      disableConfirmDescription: "Disabling prevents preview, query, and index builds for this resource until it is enabled again.",
    ...
    semanticWorkspace: {
      ...
      startConfirmTitle: "Create semantic understanding task?",
      startConfirmDescription: "This creates a semantic understanding task for the resource.",
      startConfirmWithSamplesDescription: "This creates a semantic understanding task and sends the selected sample rows for analysis.",
      empty: "No semantic-understanding tasks",
      confidenceThreshold: "Confidence threshold",
    ...
    format: {
      ...
      hundredMillionRows_one: "{{count}} row",
      hundredMillionRows_other: "{{count}} rows",
      justNow: "just now",
      minutesAgo: "{{count}}m ago",
      rows: "{{formattedCount}} rows",
      rows_one: "{{formattedCount}} row",
      rows_other: "{{formattedCount}} rows",
      tenThousandRows: "{{count}} rows",
      tenThousandRows_one: "{{count}} row",
      tenThousandRows_other: "{{count}} rows",
    },
    taskErrors: {
      dataTooLong: {
    ...
    progress: {
      ...
      syncedRows_one: "{{count}} row synced",
      syncedRows_other: "{{count}} rows synced",
    ...
    tree: {
      ...
      deleteLogicalBlockers: {
        ...
        protected_resources_other: "{{count}} protected resources",
        build_tasks_running_or_stopping: "{{count}} running or stopping build tasks",
        build_tasks_running_or_stopping_one: "{{count}} running or stopping build task",
        build_tasks_running_or_stopping_other: "{{count}} running or stopping build tasks",
        discover_tasks_running: "{{count}} running discover tasks",
        discover_tasks_running_one: "{{count}} running discover task",
        discover_tasks_running_other: "{{count}} running discover tasks",
        semantic_understanding_tasks_running: "{{count}} running semantic tasks",
        semantic_understanding_tasks_running_one: "{{count}} running semantic task",
        semantic_understanding_tasks_running_other: "{{count}} running semantic tasks",
      },
      ...
      noCatalogMatch: "No matching catalogs",
      loadMore: "Load more",
      loading: "Loading…",
    ...
    resource: {
      ...
      modifiedCount: "{{count}} fields modified",
      modifiedCount_one: "{{count}} field modified",
      modifiedCount_other: "{{count}} fields modified",
    ...
    preview: {
      ...
      fullValue: "Full value: {{field}}",
      copyFullValue: "Copy full value",
      copyFullValueSuccess: "Full value copied",
      copyFullValueFailed: "Unable to copy full value",
    ...
    build: {
      ...
      excludedSchemaFieldsHint: "The build will exclude fields unsupported by the local index: {{fields}}.",
      excludedSchemaFieldsConfirmTitle: "Exclude fields and create the build task?",
      excludedSchemaFieldsConfirmContent: "The following binary or other fields will not be queried from the source or included in the local index: {{fields}}.",
      excludedSchemaFieldsConfirmOk: "Exclude and create",
      startBuildConfirmTitle: "Create build task?",
      startBuildConfirmContent: "This creates a build task and starts processing the resource data.",
    ...
    task: {
      ...
      pauseResumeConfirmPauseTitle: "Pause build task?",
      pauseResumeConfirmPauseContent: "This changes the task state and stops its current processing.",
      pauseResumeConfirmResumeTitle: "Resume build task?",
      pauseResumeConfirmResumeContent: "This changes the task state and resumes processing.",
      rebuild: "Rebuild",
