...
export const dataCatalogZhCN = {
  dataCatalog: {
    ...
    indexWorkspace: {
      ...
      fulltextFields: "全文字段",
      primaryKeyFields: "主键字段",
      incrementalFields: "增量键字段",
    ...
    resourceWorkspace: {
      ...
      refreshMetadataConfirmTitle: "刷新资源元数据？",
      refreshMetadataConfirmDescription: "将创建元数据刷新任务。任务完成后，字段定义、资源状态和索引可用性可能发生变化。",
      refreshMetadataConfirm: "创建刷新任务",
      enableConfirmTitle: "启用资源？",
      enableConfirmDescription: "启用后可继续预览、查询和构建该资源的索引。",
      disableConfirmTitle: "停用资源？",
      disableConfirmDescription: "停用后无法预览、查询或构建该资源的索引，直到再次启用。",
      enableSuccess: "资源已启用。",
    ...
    semanticWorkspace: {
      ...
      start: "开始语义理解",
      started: "已开始语义理解任务",
      startConfirmTitle: "创建语义理解任务？",
      startConfirmDescription: "将为该资源创建语义理解任务。",
      startConfirmWithSamplesDescription: "将创建语义理解任务，并发送所选样本行用于分析。",
      empty: "暂无语义理解任务",
      confidenceThreshold: "置信度阈值",
    ...
    preview: {
      ...
      fullValue: "完整内容：{{field}}",
      copyFullValue: "复制完整内容",
      copyFullValueSuccess: "已复制完整内容",
      copyFullValueFailed: "复制完整内容失败",
      queryOriginalSource: "查询原始数据",
      loadBinaryContent: "读取 Binary 内容",
    ...
    build: {
      ...
      configReadOnly: "当前仅可查看索引配置；需要「管理数据表」权限才能编辑或保存。",
      ...
      keyFields: "主键与增量键",
      keyFieldsHint: "标签从左到右的顺序决定组合键和增量游标的字段顺序。",
      primaryKeyFieldsPlaceholder: "选择主键",
      incrementalFieldsPlaceholder: "选择增量键",
      primaryKeyFieldsHint: "选择能唯一标识一条源数据的字段；组合主键按标签顺序拼接。未包含在增量键中的主键会自动追加到内部批量游标。",
      incrementalFieldsHint: "选择用于批量构建游标推进的字段；请自行保证按标签顺序可稳定排序。未包含的主键会自动追加到内部游标。",
      fieldFeatureConfig: "字段特征配置",
      fieldFeatureConfigHint: "为文本字段配置向量嵌入和全文检索特征。",
      roleEmbedding: "向量特征",
      primaryKeyFieldCount: "主键字段数",
      incrementalFieldCount: "增量键字段数",
      embeddingFieldCount: "向量字段数",
      fulltextFieldCount: "全文检索字段数",
      rolePrimaryKey: "主键",
      roleIncrementalKey: "增量键",
      invalidKeyFields: "主键或增量键配置无效：{{fields}}。请选择存在于 schema 且类型受支持的字段。",
      removeInvalidKeyFields: "移除无效字段",
      roleFulltext: "全文检索",
      excludedSchemaFieldsHint: "构建将排除不支持索引的字段：{{fields}}。",
      excludedSchemaFieldsConfirmTitle: "确认排除字段并创建构建任务？",
      excludedSchemaFieldsConfirmContent: "以下 binary 或 other 字段不会参与源端查询或本地索引构建：{{fields}}。",
      excludedSchemaFieldsConfirmOk: "排除并创建",
      startBuildConfirmTitle: "创建构建任务？",
      startBuildConfirmContent: "将创建构建任务并开始处理资源数据。",
      ...
      defaultEmbeddingModelUsageHint: "用于将已选择的向量字段转换为向量表示。",
    ...
    task: {
      ...
      stopped: "已停止构建",
      buildResumed: "已继续构建",
      pauseResumeConfirmPauseTitle: "暂停构建任务？",
      pauseResumeConfirmPauseContent: "将变更任务状态并停止当前处理。",
      pauseResumeConfirmResumeTitle: "继续构建任务？",
      pauseResumeConfirmResumeContent: "将变更任务状态并恢复处理。",
      rebuild: "重新构建",
