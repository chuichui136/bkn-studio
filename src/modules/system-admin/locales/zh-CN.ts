...
export const systemAdminZhCN = {
  systemAdmin: {
    userPicker: {
      ...
      loadMore: "加载更多",
      loadMoreHint: "继续向下滚动可加载更多用户。",
      loadedSelectableCount: "已加载 {{count}} 位可选用户",
      memberCount: "{{count}} 人",
      organization: "组织架构",
      ...
      resultRange: "当前显示第 {{from}}–{{to}} 位，共 {{count}} 位用户",
      searchAllUsers: "搜索姓名或账号",
      searchHint: "输入姓名或账号可跨部门搜索",
      searchInlineHint: "搜索姓名或账号…",
      searchWithinDepartment: "在「{{department}}」及子组织中搜索姓名或账号",
    ...
    grant: {
      scopeLabel: "授权范围：",
      wholeType: "全部资源",
      specificResources: "指定资源",
      specificResourcesUnavailable: "该资源类型暂不支持选择具体对象",
      pickResourceFirst: "请先选择要授权的具体资源，再配置允许操作",
      allowOnlyHint: "角色授权仅允许配置允许操作；个别用户的拒绝规则请在权限管理中配置。",
      allOps: "全部操作",
      empty: "暂无授权",
      add: "添加授权",
      addOperation: "添加操作",
    ...
    objectGrants: {
      ...
      topResourceSearchPlaceholder: "搜索知识网络、数据目录或独立资源",
      topResourceType: "顶级资源类型",
      topResourceTypeAll: "全部资源类型",
      topResourceToggle: "展开或收起 {{name}}",
      topResourceLoadError: "顶级资源加载失败，请稍后重试。",
      authorize: "配置权限",
      manage: "管理",
      viewDetail: "查看详情",
      revoke: "撤销权限",
      ...
      memberPermissionDetail: "查看明细",
      memberPermissionDetailTitle: "{{name}} / 有效权限",
      memberPermissionDetailHint: "完整操作和判定依据以服务端返回为准。",
      memberInheritedFrom: "继承自：{{name}}",
      memberAuthorizationMode: "授权方式",
      memberGrantSource: "授予来源",
      memberParentResource: "所属父级：{{name}}",
      memberRootResource: "顶级资源",
      memberResourceIdentifier: "标识：{{id}}",
      granteeUser: "用户",
      granteeDept: "部门",
      deptPrefix: "部门",
    ...
    objectCount_other: "可访问 {{count}} 个对象",
      ...
      pickerNoResults: "没有匹配的对象",
      pickerLoading: "正在加载对象…",
      pickerCount: "已加载 {{loaded}} / {{total}} 个对象",
      ...
      mode: {
        community_bundle: "完整业务访问",
        professional_rule: "细粒度授权",
        legacy: "历史授权",
        system_derived: "系统派生",
        role_permission: "角色权限",
      },
    ...
    roles: {
      ...
      drawer: {
        ...
        permissions: "权限",
        permissionsHint: "选择全部资源或指定资源，并配置允许的操作",
