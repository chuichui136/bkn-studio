...
export const networkPart = {
  ...
  integrationTitle: "知识网络对接",
  copyNetworkIdentifier: "复制知识网络 ID",
  copyNetworkIdentifierFailed: "复制知识网络 ID 失败",
  networkIdentifierCopied: "知识网络 ID 已复制",
  modifier: "修改者",
  name: "知识网络名称",
  ...
  previewEdgeCount_one: "{{count}} 条关系",
  previewEdgeCount_other: "{{count}} 条关系",
  previewFitView: "适应画布",
  previewNodeCount: "{{count}} 个对象类",
  previewNodeCount_one: "{{count}} 个对象类",
  previewNodeCount_other: "{{count}} 个对象类",
  previewZoomIn: "放大",
  previewZoomOut: "缩小",
  ...
  previewIndexed: "资源已建索引",
  previewNotIndexed: "资源未建索引",
  ...
  previewColIndexState: "资源索引状态",
  previewUnbound: "未绑定",
  experienceTitle: "能力验证",
  experienceAgentTitle: "智能问答",
  experienceMcpTitle: "MCP 调试",
  experienceDescription: "用自然语言向知识网络提问，基于本体检索作答并展示检索过程。",
  experienceMcpDescription: "通过 MCP 协议对接知识网络能力，查看工具列表并验证工具调用。",
  ...
  title: "领域业务知识网络",
  toolbarHint: "当前列表页已经接入统一模块结构，后端优先对齐 bkn-backend 与 ontology-query。",
  updatedBy: "更新人：{{name}}",
  workspaceActionTypes: "行动类",
  workspaceAbilityVerification: "能力验证",
  workspaceExperienceAgent: "智能问答",
  workspaceExperienceMcp: "MCP 调试",
  workspaceConceptGroups: "概念分组",
  workspaceDescription: "工作区壳层已经迁入，后续会继续补齐旧 Vega 的完整业务页。",
  workspaceMetrics: "指标",
