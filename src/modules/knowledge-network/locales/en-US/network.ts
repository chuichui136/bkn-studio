...
export const networkPart = {
    ...
    experienceDescription: "Ask the knowledge network in natural language; answers are grounded in ontology retrieval with the retrieval trace shown.",
    experienceMcpDescription: "Connect to knowledge network capabilities through MCP, inspect tools, and verify tool calls.",
