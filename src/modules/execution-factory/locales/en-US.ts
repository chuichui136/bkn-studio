...
export const executionFactoryEnUS = {
  executionFactory: {
    ...
    unitManagementDescription:
      "Register and manage MCP servers, toolboxes, operators, and SKILLs on this platform for agent execution.",
    catalogTitle: "Capability Market",
    catalogDescription:
      "Browse published capability packs: toolsets, MCP services, and SKILL packs. The layout matches Capability Management; introduce them to this platform or sync updates for copies you already have.",
    searchNamePlaceholder: "Search name",
    typeFilter: "Category",
    functionToolboxTab: "Function Sets",
    openapiToolboxTab: "API Toolsets",
    allToolboxTab: "All Toolsets",
    originFilter: "Origin",
    originFilterAll: "All",
    ...
    businessIntro: {
      ...
      skillImportTop:
        "Upload a SKILL pack (ZIP or SKILL.md) to this platform. After publish, agents can load and run the packaged capabilities at runtime.",
      ...
      impexAdpToolbox:
        "Upload a backup file you downloaded earlier via Export on the list. Restores the toolset and all its tools. Choose import mode if the same name already exists on this platform.",
      impexAdpMcp:
    ...
    capabilityCreateMenu: {
      ...
      addFunction: "New code function",
      addFunctionDesc: "Write Python, declare inputs and outputs, debug in the sandbox.",
    },
    ...
    addCapabilityFunctionTitle: "New Code Function Toolset",
    addCapabilityFunctionDesc: "Write Python logic online — no HTTP endpoint needed",
    ...
    addCapabilitySkillDesc: "Upload a ZIP or SKILL.md package",
    ...
    searchPlaceholder: "Search by function name or ID",
    toolboxSearchPlaceholder: "Search by toolbox name or ID",
    statusFilterPlaceholder: "Filter by status",
    toolbarHint:
      "Manage execution resources on this platform—create, publish, debug, import, and export.",
    catalogToolbarHint:
    ...
    catalogEmptyByTab: {
      ...
      operator: "No functions are available to introduce from the market.",
    ...
    createWizardTypeDesc: {
      ...
      operator: "Register an OpenAPI or function for direct agent invocation.",
    ...
    detailTitle: "Function Detail",
    marketDetailTitle: "Market Function Detail",
    debug: "Debug",
    debugTitle: "Debug Function",
    runDebug: "Run Debug",
    ...
    createTitle: "Register Function",
    editTitle: "Edit Function",
    createDescription: "Register a new function via OpenAPI or function metadata.",
    editDescription: "Update function metadata and description.",
    ...
    createOperatorModalTitle: "New Function",
    createOperatorModalHint: "Choose how to create the function",
    ...
    operatorMarketTab: "Function Market",
    ...
    toolboxToolListEmptyFiltered: "No matching tools",
    ...
    introduceTitle: "Introduce to Platform",
    introduceDescription:
      'Introduce "{{name}}" from the market to this platform. You can manage and use it under Capability Management afterward.',
    introduceConfirm: "Introduce",
    introduceSuccess: "Introduced successfully",
    syncTitle: "Sync from Market",
    syncDescription:
      '"{{name}}" is already on this platform. Sync the latest market version to your local copy.',
    syncConfirm: "Start sync",
    syncSuccess: "Synced successfully",
    syncModeHint: "The market version will update or overwrite the existing copy on this platform.",
    install: "Install",
    installTitle: "Install from Market",
    installDescription: 'Install "{{name}}" on this platform?',
    ...
    skillListDescription: "Manage Agent SKILLs on this platform.",
    ...
    mcpDetailCatalogToolsHint:
      "Tool lists in catalog mode are available after introducing the MCP to this platform. If already introduced, open it from unit management.",
    ...
    functionAiGenerateQuery: "What should it do",
    functionAiGenerateQueryPlaceholder:
      "Describe the function in a sentence or two, e.g. split text on periods and drop blank segments",
    functionAiGenerateResultTitle: "Generated Result",
    functionAiGenerateApply: "Apply to Editor",
    functionAiGenerateTypes: {
      python_function_generator: "Prompt → Code",
      metadata_param_generator: "Code → Parameters",
    },
    functionAiGenerateUnusable:
      "The generated result is neither code nor parameters. Adjust the prompt and try again.",
    functionAiGenerateThinking: "Analyzing your request…",
    functionAiGenerateStreaming: "Generating code…",
    functionAiGenerateReasoning: "Model reasoning",
    functionAiParamsApplied:
      "Name, description, and parameters were derived from the code. Review them before saving.",
    functionInsertTemplate: "Template",
    functionTemplates: {
      standard: {
        title: "Basic function",
        desc: "Inputs are a few simple values: text, number, toggle",
      },
      pydantic: {
        title: "Structured input",
        desc: "Input is an object with fields inside (e.g. a customer profile)",
      },
    },
    functionTemplateOverwriteTitle: "Replace the current code?",
    functionTemplateOverwriteContent:
      "The editor already has code. Applying a template replaces all of it and cannot be undone.",
    functionTemplateOverwriteOk: "Replace",
    functionDeriveParams: "Derive Parameters",
    functionDeriveApplied: "Parameters derived from the code. Review them before saving.",
    functionDeriveUnsupported:
      "The contract could not be derived. Check that the entry point is handler(event) or a @tool function.",
    functionTemplateInserted: "Function skeleton inserted",
    ...
    parameterDescriptionPlaceholder: "Parameter description (read by agents)",
    parameterArrayItemHint:
      "Array element shape: set this entry's type to describe the element. The backend requires exactly one element definition.",
    addInputParameter: "Add Input Parameter",
    addOutputParameter: "Add Output Parameter",
    addSubParameter: "Add Sub-parameter",
    workbenchFunctionList: "Function list - {{count}}",
    workbenchFunctionListEmptyFiltered: "No matching functions",
    workbenchFilterFunctions: "Filter functions…",
    workbenchNewFunction: "New Function",
    workbenchUnnamedFunction: "Unnamed function",
    workbenchDeleteFunction: "Delete function",
    workbenchDuplicateFunction: "Duplicate function",
    workbenchStatusHint:
      "Controls whether agents can call this function. Disabled functions stay editable and debuggable.",
    workbenchDisabledBanner:
      "This function is disabled and agents cannot call it. The code stays editable and debuggable; enabling takes effect immediately.",
    ...
    workbenchInstallingDependencies:
      "Installing dependencies in the sandbox — this happens on every run, so large packages are slow…",
    ...
    workbenchLeaveConfirmOk: "Discard and leave",
    workbenchUnnamed: "unnamed",
    workbenchClickToName: "Click to name (e.g. high_value_customers)",
    workbenchUnsaved: "unsaved",
    ioInCount: "{{count}} in",
    ioOutCount: "{{count}} out",
    workbenchFunctionLabel: "Function ·",
    ...
    workbenchDepsTab: "Dependencies",
    workbenchNoParameters: "No parameters yet. Add some to declare the function contract.",
    workbenchParamsHint:
      "Keeping parameters in sync with the code is up to you (the backend does not enforce it). Use AI Generate → Code to Parameters after editing code.",
    workbenchNoFunction: "No function yet. Create one from the left rail.",
    workbenchConsoleTitle: "Debug Console",
    workbenchConsoleNote: "Runs the code in the editor · temporary, not persisted",
    ...
    workbenchDependencyEmpty: "No dependencies declared; the sandbox built-in environment is used",
    workbenchDependencyVersion: "Version",
    workbenchDependencyPlaceholder: "Package name, e.g. pandas / requests",
    workbenchDependencyDuplicate: "That dependency is already declared",
    workbenchDependencyInvalidName:
      "Package names may contain only letters, digits, and - _ . and must start and end with a letter or digit",
