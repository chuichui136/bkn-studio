...
export const bknTraceEnUS = {
  bknTrace: {
    ...
    settings: {
      ...
      readOnlyNotice: "Log retention policies are read-only. Trace and evidence changes run through the managed release controller with automatic rollback.",
		...
		confirmReleaseImpact: "This performs a rolling release of managed services; old and new instances may briefly coexist.",
    ...
    errors: {
      ...
      traceEvidenceUpdateFailed: "The release request was not accepted. The latest server state has been reloaded; review it and try again.",
    },
    emptyStates: {
