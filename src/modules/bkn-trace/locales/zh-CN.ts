  ...
  bknTrace: {
    businessProvenance: {
      ...
      workspace: {
        ...
        callCount: "{{count}} 次调用", columns: { duration: "耗时", evidence: "证据完整性", interactions: "交互轮次", question: "用户问题", result: "业务结果", startedAt: "开始时间", status: "状态" },
        ...
        inputNotRecorded: "用户输入未记录", interactionCount: "{{count}} 轮交互", interfaceNotRecorded: "接口未记录",
        knowledge: {
          closeDetail: "关闭知识网络详情", contextOnly: "知识网络上下文，非本轮调用", deterministicCalls: "{{count}} 次确定性调用", empty: "本轮尚未记录能够确定性定位到 BKN 元素的调用",
          factBoundary: "事实边界", factBoundaryDescription: "本轮有 {{count}} 次调用确定性定位到该业务元素。", network: "业务知识网络", noContext: "本轮未记录可展示的关系上下文。",
        ...
        rounds: { input: "本轮输入", inputOriginal: "本轮输入（原文）", outputOriginal: "本轮输出（原文）", search: "搜索问题或业务对象", select: "选择交互轮次查看调用事实", summary: "共 {{total}} 轮 · 当前 {{current}} 轮", title: "交互轮次", viewFull: "查看完整原文", viewFullInput: "查看完整本轮输入", viewFullOutput: "查看完整本轮输出" },
    ...
    logs: {
      ...
      partialWarning: "部分日志来源尚未接入或暂不可用，当前结果可能不完整。",
    ...
    settings: {
      ...
      metrics: { healthy: "已接入", registered: "已登记来源", unavailable: "异常", unconfigured: "未接入", updatedAt: "最近更新时间" },
      noIssueReturned: "接口未返回异常或丢弃信息",
      notReturned: "接口未返回",
      overview: "运行概览",
      policies: "保留与存储策略",
